...
describe Sphere do
    ...
    describe "#to_lonlat" do
        ...
        it "should return (0.75, 0.5) for (0, -1, 0)" do
    ...
    describe "#to_lonlat_c" do
        it "should return (0.5, 0.5) for (1, 0, 0)" do
            lon, lat = @instance.to_lonlat_c Point.new(1, 0, 0)
            lon.should == 0.5
            lat.should == 0.5
        end
        it "should return (0.75, 0.5) for (0, -1, 0)" do
            lon, lat = @instance.to_lonlat_c Point.new(0, -1, 0)
            lon.should == 0.75
            lat.should == 0.5
        end
        ...
        it "should return (0.5, 0.25) for (1, 0, 1)" do
            lon, lat = @instance.to_lonlat_c Point.new(1, 0, 1)
            lon.should == 0.5
            lat.should be_within(0.001).of(0.25)
        end
  end
  ...
  describe "#to_p" do
      ...
      it "takes a lon, lat (0.5, 0.25) and returns (1, 0, 1)" do
        p = @instance.to_p(0.5, 0.25)
        p.x.should be_within(0.001).of(1)
        p.y.should be_within(0.001).of(0)
        p.z.should be_within(0.001).of(1)
      end
